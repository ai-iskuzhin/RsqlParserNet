...
Use `RsqlParserNet.FastEndpoints` when an API should add invalid RSQL input to FastEndpoints' validation failure flow. The adapter targets `FastEndpoints` `8.0.0` or newer. See [fastendpoints-usage.md](fastendpoints-usage.md).
